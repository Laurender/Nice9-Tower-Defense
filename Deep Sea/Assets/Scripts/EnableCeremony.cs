...
{
    [SerializeField, Tooltip("This is needed for GUI elements that have layout components active and can be used for anything that has a (1,1,1) scaling in editor.")]
